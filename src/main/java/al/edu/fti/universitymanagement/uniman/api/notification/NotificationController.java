...
public class NotificationController extends BaseController<NotificationDto, NotificationEntity> {
    ...
    @Override
    public ResponseEntity<List<NotificationDto>> filter(@RequestBody FilterWrap filterWrap) {
        return ResponseEntity.ok(baseService.findAll(filterWrap, NotificationEntity.class));
